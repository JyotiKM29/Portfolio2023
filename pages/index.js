  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Jyoti KM is a full stack  from India.
She build things for the web.
she is developer proficient in React and Next.js, she is specialize in crafting captivating websites with stunning animations using GSAP. she craft flawless, captivating websites that uniquely showcase your brand, irresistibly drawing in your target audience." 
       />
